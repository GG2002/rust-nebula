...
use super::configuration::AsyncTransportConfiguration;
use crate::fbthrift::{Framing, FramingDecoded, FramingEncodedFinal, Transport};
...
impl<H> AsyncTransport<super::impl_tokio::TokioTcpStream, super::impl_tokio::TokioSleep, H>
where
    H: ResponseHandler + Unpin,
{
    pub async fn with_tokio_tcp_connect<A: tokio::net::ToSocketAddrs>(
        ...
        let stream = super::impl_tokio::tcp_connect(addr).await?;
