...
pub enum Value {
    nVal(super::types::NullType),
    bVal(::std::primitive::bool),
    iVal(::std::primitive::i64),
    fVal(super::double::Double),
    sVal(::std::vec::Vec<::std::primitive::u8>),
    dVal(super::types::Date),
    tVal(super::types::Time),
    dtVal(super::types::DateTime),
    vVal(Box<super::types::Vertex>),
    eVal(super::types::Edge),
    pVal(super::types::Path),
    lVal(super::types::NList),
    mVal(super::types::NMap),
    uVal(super::types::NSet),
    gVal(super::types::DataSet),
    ggVal(super::types::Geography),
    duVal(super::types::Duration),
    UnknownField(::std::primitive::i32),
}

#[derive(Clone, PartialEq, Eq, PartialOrd, Ord)]
pub struct NList {
    pub values: ::std::vec::Vec<super::types::Value>,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
    // the definition in Thrift. If you don't want this, add the annotation
    // `(rust.exhaustive)` to the Thrift struct to eliminate this field.
...
pub struct NMap {
    pub kvs:
        ::std::collections::BTreeMap<::std::vec::Vec<::std::primitive::u8>, super::types::Value>,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
    // the definition in Thrift. If you don't want this, add the annotation
    // `(rust.exhaustive)` to the Thrift struct to eliminate this field.
...
#[derive(Clone, PartialEq, Eq, PartialOrd, Ord)]
pub struct NSet {
    pub values: ::std::collections::BTreeSet<super::types::Value>,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
    // the definition in Thrift. If you don't want this, add the annotation
    // `(rust.exhaustive)` to the Thrift struct to eliminate this field.
...
pub struct DataSet {
    ...
    pub rows: ::std::vec::Vec<super::types::Row>,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
    // the definition in Thrift. If you don't want this, add the annotation
    // `(rust.exhaustive)` to the Thrift struct to eliminate this field.
...
pub struct Coordinate {
    pub x: super::double::Double,
    pub y: super::double::Double,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
    // the definition in Thrift. If you don't want this, add the annotation
    // `(rust.exhaustive)` to the Thrift struct to eliminate this field.
...
#[derive(Clone, PartialEq, Eq, PartialOrd, Ord)]
pub struct Point {
    pub coord: super::types::Coordinate,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
    // the definition in Thrift. If you don't want this, add the annotation
    // `(rust.exhaustive)` to the Thrift struct to eliminate this field.
...
pub struct LineString {
    pub coordList: ::std::vec::Vec<super::types::Coordinate>,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
    // the definition in Thrift. If you don't want this, add the annotation
    // `(rust.exhaustive)` to the Thrift struct to eliminate this field.
...
#[derive(Clone, PartialEq, Eq, PartialOrd, Ord)]
pub struct Polygon {
    pub coordListList: ::std::vec::Vec<::std::vec::Vec<super::types::Coordinate>>,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
    // the definition in Thrift. If you don't want this, add the annotation
    // `(rust.exhaustive)` to the Thrift struct to eliminate this field.
...
#[derive(Clone, PartialEq, Debug, Eq, PartialOrd, Ord)]
pub enum Geography {
    ptVal(super::types::Point),
    lsVal(super::types::LineString),
    pgVal(super::types::Polygon),
    UnknownField(::std::primitive::i32),
}
...
#[derive(Clone, PartialEq, Eq, PartialOrd, Ord)]
pub struct Edge {
    pub src: Box<super::types::Value>,
    pub dst: Box<super::types::Value>,
    pub r#type: super::types::EdgeType,
    pub name: ::std::vec::Vec<::std::primitive::u8>,
    pub ranking: super::types::EdgeRanking,
    pub props:
        ::std::collections::BTreeMap<::std::vec::Vec<::std::primitive::u8>, super::types::Value>,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
...
#[derive(Clone, PartialEq, Eq, PartialOrd, Ord)]
pub struct Path {
    pub src: super::types::Vertex,
    pub steps: ::std::vec::Vec<super::types::Step>,
    // This field forces `..Default::default()` when instantiating this
    // struct, to make code future-proof against new fields added later to
    // the definition in Thrift. If you don't want this, add the annotation
    // `(rust.exhaustive)` to the Thrift struct to eliminate this field.
...
#[derive(Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct LogInfo {
    pub log_id: super::types::LogID,
    pub term_id: super::types::TermID,
    pub commit_log_id: super::types::LogID,
...
pub struct CheckpointInfo {
    pub space_id: super::types::GraphSpaceID,
    pub parts: ::std::collections::BTreeMap<super::types::PartitionID, super::types::LogInfo>,
...
#[derive(Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct LogEntry {
    pub cluster: super::types::ClusterID,
...
impl crate::fbthrift::ThriftEnum for NullType {
...
impl ::std::str::FromStr for NullType {
    ...
    fn from_str(string: &::std::primitive::str) -> ::std::result::Result<Self, Self::Err> {
        ...
        crate::fbthrift::help::enum_from_str(VARIANTS_BY_NAME, string, "NullType").map(Self)
    }
}

impl crate::fbthrift::GetTType for NullType {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::I32;
}

impl<P> crate::fbthrift::Serialize<P> for NullType
where
...
impl<P> crate::fbthrift::Deserialize<P> for NullType
where
...
impl crate::fbthrift::ThriftEnum for PropertyType {
    fn enumerate() -> &'static [(Self, &'static str)] {
        &[
...
impl ::std::str::FromStr for PropertyType {
    ...
    fn from_str(string: &::std::primitive::str) -> ::std::result::Result<Self, Self::Err> {
        ...
        crate::fbthrift::help::enum_from_str(VARIANTS_BY_NAME, string, "PropertyType").map(Self)
    }
}

impl crate::fbthrift::GetTType for PropertyType {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::I32;
}

impl<P> crate::fbthrift::Serialize<P> for PropertyType
where
    P: crate::fbthrift::ProtocolWriter,
{
    #[inline]
...
impl<P> crate::fbthrift::Deserialize<P> for PropertyType
where
    P: crate::fbthrift::ProtocolReader,
{
    #[inline]
...
impl crate::fbthrift::ThriftEnum for ErrorCode {
    fn enumerate() -> &'static [(Self, &'static str)] {
        &[
...
impl ::std::str::FromStr for ErrorCode {
    ...
    fn from_str(string: &::std::primitive::str) -> ::std::result::Result<Self, Self::Err> {
        ...
        crate::fbthrift::help::enum_from_str(VARIANTS_BY_NAME, string, "ErrorCode").map(Self)
    }
}

impl crate::fbthrift::GetTType for ErrorCode {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::I32;
}

impl<P> crate::fbthrift::Serialize<P> for ErrorCode
where
    P: crate::fbthrift::ProtocolWriter,
{
    #[inline]
...
impl<P> crate::fbthrift::Deserialize<P> for ErrorCode
where
    P: crate::fbthrift::ProtocolReader,
{
    #[inline]
...
impl crate::fbthrift::GetTType for SchemaID {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for SchemaID
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
...
impl<P> crate::fbthrift::Deserialize<P> for SchemaID
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32, once) {
                ...
                (crate::fbthrift::TType::I32, 1, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::tag_id(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::I32, 2, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::edge_type(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
...
impl crate::fbthrift::GetTType for self::Date {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Date
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("Date");
        p.write_field_begin("year", crate::fbthrift::TType::I16, 1);
        crate::fbthrift::Serialize::write(&self.year, p);
        p.write_field_end();
        p.write_field_begin("month", crate::fbthrift::TType::Byte, 2);
        crate::fbthrift::Serialize::write(&self.month, p);
        p.write_field_end();
        p.write_field_begin("day", crate::fbthrift::TType::Byte, 3);
        crate::fbthrift::Serialize::write(&self.day, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::Date
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("day", crate::fbthrift::TType::Byte, 3),
            crate::fbthrift::Field::new("month", crate::fbthrift::TType::Byte, 2),
            crate::fbthrift::Field::new("year", crate::fbthrift::TType::I16, 1),
        ];
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                ...
                (crate::fbthrift::TType::I16, 1) => {
                    field_year = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::Byte, 2) => {
                    field_month =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::Byte, 3) => {
                    field_day = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
...
impl crate::fbthrift::GetTType for self::Time {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Time
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("Time");
        p.write_field_begin("hour", crate::fbthrift::TType::Byte, 1);
        crate::fbthrift::Serialize::write(&self.hour, p);
        p.write_field_end();
        p.write_field_begin("minute", crate::fbthrift::TType::Byte, 2);
        crate::fbthrift::Serialize::write(&self.minute, p);
        p.write_field_end();
        p.write_field_begin("sec", crate::fbthrift::TType::Byte, 3);
        crate::fbthrift::Serialize::write(&self.sec, p);
        p.write_field_end();
        p.write_field_begin("microsec", crate::fbthrift::TType::I32, 4);
        crate::fbthrift::Serialize::write(&self.microsec, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::Time
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("hour", crate::fbthrift::TType::Byte, 1),
            crate::fbthrift::Field::new("microsec", crate::fbthrift::TType::I32, 4),
            crate::fbthrift::Field::new("minute", crate::fbthrift::TType::Byte, 2),
            crate::fbthrift::Field::new("sec", crate::fbthrift::TType::Byte, 3),
        ];
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (crate::fbthrift::TType::Stop, _) => break,
                (crate::fbthrift::TType::Byte, 1) => {
                    field_hour = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::Byte, 2) => {
                    field_minute =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                ...
                (crate::fbthrift::TType::Byte, 3) => {
                    field_sec = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
...
impl crate::fbthrift::GetTType for self::DateTime {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::DateTime
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        crate::fbthrift::Serialize::write(&self.day, p);
        p.write_field_end();
        p.write_field_begin("hour", crate::fbthrift::TType::Byte, 4);
        crate::fbthrift::Serialize::write(&self.hour, p);
        p.write_field_end();
        p.write_field_begin("minute", crate::fbthrift::TType::Byte, 5);
        crate::fbthrift::Serialize::write(&self.minute, p);
        p.write_field_end();
        p.write_field_begin("sec", crate::fbthrift::TType::Byte, 6);
        crate::fbthrift::Serialize::write(&self.sec, p);
        p.write_field_end();
        p.write_field_begin("microsec", crate::fbthrift::TType::I32, 7);
        crate::fbthrift::Serialize::write(&self.microsec, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
...
impl<P> crate::fbthrift::Deserialize<P> for self::DateTime
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("day", crate::fbthrift::TType::Byte, 3),
            crate::fbthrift::Field::new("hour", crate::fbthrift::TType::Byte, 4),
            crate::fbthrift::Field::new("microsec", crate::fbthrift::TType::I32, 7),
            crate::fbthrift::Field::new("minute", crate::fbthrift::TType::Byte, 5),
            crate::fbthrift::Field::new("month", crate::fbthrift::TType::Byte, 2),
            crate::fbthrift::Field::new("sec", crate::fbthrift::TType::Byte, 6),
            crate::fbthrift::Field::new("year", crate::fbthrift::TType::I16, 1),
        ];
        let mut field_year = ::std::option::Option::None;
        let mut field_month = ::std::option::Option::None;
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                ...
                (crate::fbthrift::TType::Byte, 4) => {
                    field_hour = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::Byte, 5) => {
                    field_minute =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::Byte, 6) => {
                    field_sec = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::I32, 7) => {
                    field_microsec =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (fty, _) => p.skip(fty)?,
...
impl crate::fbthrift::GetTType for Value {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for Value
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        match self {
            Self::nVal(inner) => {
                p.write_field_begin("nVal", crate::fbthrift::TType::I32, 1);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::bVal(inner) => {
                p.write_field_begin("bVal", crate::fbthrift::TType::Bool, 2);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::iVal(inner) => {
                p.write_field_begin("iVal", crate::fbthrift::TType::I64, 3);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::fVal(inner) => {
                p.write_field_begin("fVal", crate::fbthrift::TType::Double, 4);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::sVal(inner) => {
                p.write_field_begin("sVal", crate::fbthrift::TType::String, 5);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::dVal(inner) => {
                p.write_field_begin("dVal", crate::fbthrift::TType::Struct, 6);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::tVal(inner) => {
                p.write_field_begin("tVal", crate::fbthrift::TType::Struct, 7);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::dtVal(inner) => {
                p.write_field_begin("dtVal", crate::fbthrift::TType::Struct, 8);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::vVal(inner) => {
                p.write_field_begin("vVal", crate::fbthrift::TType::Struct, 9);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::eVal(inner) => {
                p.write_field_begin("eVal", crate::fbthrift::TType::Struct, 10);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::pVal(inner) => {
                p.write_field_begin("pVal", crate::fbthrift::TType::Struct, 11);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::lVal(inner) => {
                p.write_field_begin("lVal", crate::fbthrift::TType::Struct, 12);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::mVal(inner) => {
                p.write_field_begin("mVal", crate::fbthrift::TType::Struct, 13);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::uVal(inner) => {
                p.write_field_begin("uVal", crate::fbthrift::TType::Struct, 14);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::gVal(inner) => {
                p.write_field_begin("gVal", crate::fbthrift::TType::Struct, 15);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::ggVal(inner) => {
                p.write_field_begin("ggVal", crate::fbthrift::TType::Struct, 16);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::duVal(inner) => {
                p.write_field_begin("duVal", crate::fbthrift::TType::Struct, 17);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::UnknownField(_) => {}
...
impl<P> crate::fbthrift::Deserialize<P> for Value
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("bVal", crate::fbthrift::TType::Bool, 2),
            crate::fbthrift::Field::new("dVal", crate::fbthrift::TType::Struct, 6),
            crate::fbthrift::Field::new("dtVal", crate::fbthrift::TType::Struct, 8),
            crate::fbthrift::Field::new("duVal", crate::fbthrift::TType::Struct, 17),
            crate::fbthrift::Field::new("eVal", crate::fbthrift::TType::Struct, 10),
            crate::fbthrift::Field::new("fVal", crate::fbthrift::TType::Double, 4),
            crate::fbthrift::Field::new("gVal", crate::fbthrift::TType::Struct, 15),
            crate::fbthrift::Field::new("ggVal", crate::fbthrift::TType::Struct, 16),
            crate::fbthrift::Field::new("iVal", crate::fbthrift::TType::I64, 3),
            crate::fbthrift::Field::new("lVal", crate::fbthrift::TType::Struct, 12),
            crate::fbthrift::Field::new("mVal", crate::fbthrift::TType::Struct, 13),
            crate::fbthrift::Field::new("nVal", crate::fbthrift::TType::I32, 1),
            crate::fbthrift::Field::new("pVal", crate::fbthrift::TType::Struct, 11),
            crate::fbthrift::Field::new("sVal", crate::fbthrift::TType::String, 5),
            crate::fbthrift::Field::new("tVal", crate::fbthrift::TType::Struct, 7),
            crate::fbthrift::Field::new("uVal", crate::fbthrift::TType::Struct, 14),
            crate::fbthrift::Field::new("vVal", crate::fbthrift::TType::Struct, 9),
        ];
        let _ = p.read_struct_begin(|_| ())?;
        let mut once = false;
        let mut alt = ::std::option::Option::None;
        loop {
            ...
            match (fty, fid as ::std::primitive::i32, once) {
                ...
                (crate::fbthrift::TType::I32, 1, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::nVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Bool, 2, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::bVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::I64, 3, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::iVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Double, 4, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::fVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::String, 5, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::sVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 6, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::dVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 7, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::tVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 8, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::dtVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 9, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::vVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 10, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::eVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 11, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::pVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 12, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::lVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 13, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::mVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 14, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::uVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 15, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::gVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 16, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::ggVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 17, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::duVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (fty, _, false) => p.skip(fty)?,
...
impl crate::fbthrift::GetTType for self::NList {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::NList
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("NList");
        p.write_field_begin("values", crate::fbthrift::TType::List, 1);
        crate::fbthrift::Serialize::write(&self.values, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::NList
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
...
impl crate::fbthrift::GetTType for self::NMap {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::NMap
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("NMap");
        p.write_field_begin("kvs", crate::fbthrift::TType::Map, 1);
        crate::fbthrift::Serialize::write(&self.kvs, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::NMap
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (crate::fbthrift::TType::Stop, _) => break,
                (crate::fbthrift::TType::Map, 1) => {
                    field_kvs = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
...
impl crate::fbthrift::GetTType for self::NSet {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::NSet
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("NSet");
        p.write_field_begin("values", crate::fbthrift::TType::Set, 1);
        crate::fbthrift::Serialize::write(&self.values, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
...
impl<P> crate::fbthrift::Deserialize<P> for self::NSet
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
...
impl crate::fbthrift::GetTType for self::Row {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Row
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
...
impl<P> crate::fbthrift::Deserialize<P> for self::Row
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
...
impl crate::fbthrift::GetTType for self::DataSet {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::DataSet
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("DataSet");
        p.write_field_begin("column_names", crate::fbthrift::TType::List, 1);
        crate::fbthrift::Serialize::write(&self.column_names, p);
        p.write_field_end();
        p.write_field_begin("rows", crate::fbthrift::TType::List, 2);
        crate::fbthrift::Serialize::write(&self.rows, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::DataSet
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("column_names", crate::fbthrift::TType::List, 1),
            crate::fbthrift::Field::new("rows", crate::fbthrift::TType::List, 2),
        ];
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                ...
                (crate::fbthrift::TType::List, 2) => {
                    field_rows = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
...
impl crate::fbthrift::GetTType for self::Coordinate {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Coordinate
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("Coordinate");
        p.write_field_begin("x", crate::fbthrift::TType::Double, 1);
        crate::fbthrift::Serialize::write(&self.x, p);
        p.write_field_end();
        p.write_field_begin("y", crate::fbthrift::TType::Double, 2);
        crate::fbthrift::Serialize::write(&self.y, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::Coordinate
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("x", crate::fbthrift::TType::Double, 1),
            crate::fbthrift::Field::new("y", crate::fbthrift::TType::Double, 2),
        ];
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (crate::fbthrift::TType::Stop, _) => break,
                (crate::fbthrift::TType::Double, 1) => {
                    field_x = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::Double, 2) => {
                    field_y = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
...
impl crate::fbthrift::GetTType for self::Point {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Point
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("Point");
        p.write_field_begin("coord", crate::fbthrift::TType::Struct, 1);
        crate::fbthrift::Serialize::write(&self.coord, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::Point
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
...
impl crate::fbthrift::GetTType for self::LineString {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::LineString
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("LineString");
        p.write_field_begin("coordList", crate::fbthrift::TType::List, 1);
        crate::fbthrift::Serialize::write(&self.coordList, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::LineString
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
...
impl crate::fbthrift::GetTType for self::Polygon {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Polygon
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("Polygon");
        p.write_field_begin("coordListList", crate::fbthrift::TType::List, 1);
        crate::fbthrift::Serialize::write(&self.coordListList, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::Polygon
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
...
impl crate::fbthrift::GetTType for Geography {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for Geography
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        match self {
            Self::ptVal(inner) => {
                p.write_field_begin("ptVal", crate::fbthrift::TType::Struct, 1);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::lsVal(inner) => {
                p.write_field_begin("lsVal", crate::fbthrift::TType::Struct, 2);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::pgVal(inner) => {
                p.write_field_begin("pgVal", crate::fbthrift::TType::Struct, 3);
                crate::fbthrift::Serialize::write(inner, p);
                p.write_field_end();
            }
            Self::UnknownField(_) => {}
...
impl<P> crate::fbthrift::Deserialize<P> for Geography
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("lsVal", crate::fbthrift::TType::Struct, 2),
            crate::fbthrift::Field::new("pgVal", crate::fbthrift::TType::Struct, 3),
            crate::fbthrift::Field::new("ptVal", crate::fbthrift::TType::Struct, 1),
        ];
        let _ = p.read_struct_begin(|_| ())?;
        let mut once = false;
        let mut alt = ::std::option::Option::None;
        loop {
            ...
            match (fty, fid as ::std::primitive::i32, once) {
                (crate::fbthrift::TType::Stop, _, _) => break,
                (crate::fbthrift::TType::Struct, 1, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::ptVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 2, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::lsVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (crate::fbthrift::TType::Struct, 3, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::pgVal(
                        crate::fbthrift::Deserialize::read(p)?,
                    ));
                }
                (fty, _, false) => p.skip(fty)?,
...
impl crate::fbthrift::GetTType for self::Tag {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Tag
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        p.write_field_end();
        p.write_field_begin("props", crate::fbthrift::TType::Map, 2);
...
impl<P> crate::fbthrift::Deserialize<P> for self::Tag
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            ...
            crate::fbthrift::Field::new("props", crate::fbthrift::TType::Map, 2),
        ];
...
impl crate::fbthrift::GetTType for self::Vertex {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Vertex
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("Vertex");
        p.write_field_begin("vid", crate::fbthrift::TType::Struct, 1);
        crate::fbthrift::Serialize::write(&self.vid, p);
        p.write_field_end();
...
impl<P> crate::fbthrift::Deserialize<P> for self::Vertex
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            ...
            crate::fbthrift::Field::new("vid", crate::fbthrift::TType::Struct, 1),
        ];
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (crate::fbthrift::TType::Stop, _) => break,
                (crate::fbthrift::TType::Struct, 1) => {
                    field_vid = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::List, 2) => {
...
impl crate::fbthrift::GetTType for self::Edge {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Edge
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        p.write_field_end();
        p.write_field_begin("dst", crate::fbthrift::TType::Struct, 2);
        ...
        p.write_field_end();
        p.write_field_begin("name", crate::fbthrift::TType::String, 4);
        crate::fbthrift::Serialize::write(&self.name, p);
        p.write_field_end();
        p.write_field_begin("ranking", crate::fbthrift::TType::I64, 5);
        crate::fbthrift::Serialize::write(&self.ranking, p);
        p.write_field_end();
        p.write_field_begin("props", crate::fbthrift::TType::Map, 6);
        crate::fbthrift::Serialize::write(&self.props, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
...
impl<P> crate::fbthrift::Deserialize<P> for self::Edge
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("dst", crate::fbthrift::TType::Struct, 2),
            crate::fbthrift::Field::new("name", crate::fbthrift::TType::String, 4),
            crate::fbthrift::Field::new("props", crate::fbthrift::TType::Map, 6),
            crate::fbthrift::Field::new("ranking", crate::fbthrift::TType::I64, 5),
...
impl crate::fbthrift::GetTType for self::Step {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Step
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("Step");
        p.write_field_begin("dst", crate::fbthrift::TType::Struct, 1);
        crate::fbthrift::Serialize::write(&self.dst, p);
        p.write_field_end();
        ...
        crate::fbthrift::Serialize::write(&self.name, p);
        p.write_field_end();
        p.write_field_begin("ranking", crate::fbthrift::TType::I64, 4);
        crate::fbthrift::Serialize::write(&self.ranking, p);
        p.write_field_end();
        p.write_field_begin("props", crate::fbthrift::TType::Map, 5);
        crate::fbthrift::Serialize::write(&self.props, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
...
impl<P> crate::fbthrift::Deserialize<P> for self::Step
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("dst", crate::fbthrift::TType::Struct, 1),
            crate::fbthrift::Field::new("name", crate::fbthrift::TType::String, 3),
            crate::fbthrift::Field::new("props", crate::fbthrift::TType::Map, 5),
            crate::fbthrift::Field::new("ranking", crate::fbthrift::TType::I64, 4),
...
impl crate::fbthrift::GetTType for self::Path {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Path
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        crate::fbthrift::Serialize::write(&self.src, p);
        p.write_field_end();
        p.write_field_begin("steps", crate::fbthrift::TType::List, 2);
        crate::fbthrift::Serialize::write(&self.steps, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::Path
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("src", crate::fbthrift::TType::Struct, 1),
            crate::fbthrift::Field::new("steps", crate::fbthrift::TType::List, 2),
        ];
        let mut field_src = ::std::option::Option::None;
...
impl crate::fbthrift::GetTType for self::HostAddr {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::HostAddr
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        p.write_field_end();
        p.write_field_begin("port", crate::fbthrift::TType::I32, 2);
        crate::fbthrift::Serialize::write(&self.port, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::HostAddr
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            ...
            crate::fbthrift::Field::new("port", crate::fbthrift::TType::I32, 2),
        ];
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (crate::fbthrift::TType::Stop, _) => break,
                (crate::fbthrift::TType::String, 1) => {
                    field_host = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::I32, 2) => {
                    field_port = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
...
impl crate::fbthrift::GetTType for self::KeyValue {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::KeyValue
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("KeyValue");
        p.write_field_begin("key", crate::fbthrift::TType::String, 1);
...
impl<P> crate::fbthrift::Deserialize<P> for self::KeyValue
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("key", crate::fbthrift::TType::String, 1),
...
impl crate::fbthrift::GetTType for self::Duration {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Duration
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("Duration");
        p.write_field_begin("seconds", crate::fbthrift::TType::I64, 1);
        crate::fbthrift::Serialize::write(&self.seconds, p);
        p.write_field_end();
        p.write_field_begin("microseconds", crate::fbthrift::TType::I32, 2);
        crate::fbthrift::Serialize::write(&self.microseconds, p);
        p.write_field_end();
        p.write_field_begin("months", crate::fbthrift::TType::I32, 3);
        crate::fbthrift::Serialize::write(&self.months, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::Duration
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("microseconds", crate::fbthrift::TType::I32, 2),
            crate::fbthrift::Field::new("months", crate::fbthrift::TType::I32, 3),
            crate::fbthrift::Field::new("seconds", crate::fbthrift::TType::I64, 1),
        ];
...
impl crate::fbthrift::GetTType for self::LogInfo {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::LogInfo
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("LogInfo");
        p.write_field_begin("log_id", crate::fbthrift::TType::I64, 1);
        crate::fbthrift::Serialize::write(&self.log_id, p);
        p.write_field_end();
        p.write_field_begin("term_id", crate::fbthrift::TType::I64, 2);
        crate::fbthrift::Serialize::write(&self.term_id, p);
        p.write_field_end();
        p.write_field_begin("commit_log_id", crate::fbthrift::TType::I64, 3);
        crate::fbthrift::Serialize::write(&self.commit_log_id, p);
        p.write_field_end();
        p.write_field_begin("checkpoint_path", crate::fbthrift::TType::String, 4);
        crate::fbthrift::Serialize::write(&self.checkpoint_path, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::LogInfo
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("checkpoint_path", crate::fbthrift::TType::String, 4),
            crate::fbthrift::Field::new("commit_log_id", crate::fbthrift::TType::I64, 3),
            crate::fbthrift::Field::new("log_id", crate::fbthrift::TType::I64, 1),
            crate::fbthrift::Field::new("term_id", crate::fbthrift::TType::I64, 2),
        ];
...
impl crate::fbthrift::GetTType for self::DirInfo {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::DirInfo
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("DirInfo");
        p.write_field_begin("root", crate::fbthrift::TType::String, 1);
        crate::fbthrift::Serialize::write(&self.root, p);
        p.write_field_end();
        p.write_field_begin("data", crate::fbthrift::TType::List, 2);
        crate::fbthrift::Serialize::write(&self.data, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::DirInfo
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("data", crate::fbthrift::TType::List, 2),
            crate::fbthrift::Field::new("root", crate::fbthrift::TType::String, 1),
        ];
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (crate::fbthrift::TType::Stop, _) => break,
                (crate::fbthrift::TType::String, 1) => {
                    field_root = ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::List, 2) => {
...
impl crate::fbthrift::GetTType for self::CheckpointInfo {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::CheckpointInfo
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        p.write_field_end();
        p.write_field_begin("data_path", crate::fbthrift::TType::String, 3);
        crate::fbthrift::Serialize::write(&self.data_path, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::CheckpointInfo
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("data_path", crate::fbthrift::TType::String, 3),
...
impl crate::fbthrift::GetTType for self::LogEntry {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::LogEntry
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("LogEntry");
        p.write_field_begin("cluster", crate::fbthrift::TType::I64, 1);
        crate::fbthrift::Serialize::write(&self.cluster, p);
        p.write_field_end();
        p.write_field_begin("log_str", crate::fbthrift::TType::String, 2);
        crate::fbthrift::Serialize::write(&self.log_str, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::LogEntry
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("cluster", crate::fbthrift::TType::I64, 1),
            crate::fbthrift::Field::new("log_str", crate::fbthrift::TType::String, 2),
        ];
...
mod dot_dot {
    ...
    pub struct OtherFields(pub(super) ());
