...
///     pub fn mock_result(
///         &self,
///         mock: impl FnMut(FunctionRequest) -> Result<FunctionResponse, super::services::MyService::MyFunctionExn> + Send + Sync + 'mock,
///     );
///
///     // return one of the function's declared exceptions
///     pub fn throw<E>(&self, exception: E)
///     where
///         E: Clone + Into<super::services::MyService::MyFunctionExn> + Send + Sync + 'mock;
/// }
///
...
/// Error return crate::fbthrift_protocol::graph::types.
pub mod errors {
    /// crate::fbthrift_protocol::graph::errors for GraphService functions.
    use super::*;
