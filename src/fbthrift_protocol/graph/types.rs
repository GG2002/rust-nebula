...
pub struct ProfilingStats {
    ...
    pub other_stats: ::std::option::Option<
...
pub struct PlanNodeDescription {
    ...
    pub description: ::std::option::Option<::std::vec::Vec<super::types::Pair>>,
    pub profiles: ::std::option::Option<::std::vec::Vec<super::types::ProfilingStats>>,
    pub branch_info: ::std::option::Option<super::types::PlanNodeBranchInfo>,
...
pub struct PlanDescription {
    pub plan_node_descs: ::std::vec::Vec<super::types::PlanNodeDescription>,
...
pub struct ExecutionResponse {
    ...
    pub plan_desc: ::std::option::Option<super::types::PlanDescription>,
...
impl crate::fbthrift::GetTType for self::ProfilingStats {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::ProfilingStats
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("ProfilingStats");
        p.write_field_begin("rows", crate::fbthrift::TType::I64, 1);
        crate::fbthrift::Serialize::write(&self.rows, p);
        p.write_field_end();
        p.write_field_begin("exec_duration_in_us", crate::fbthrift::TType::I64, 2);
        crate::fbthrift::Serialize::write(&self.exec_duration_in_us, p);
        p.write_field_end();
        p.write_field_begin("total_duration_in_us", crate::fbthrift::TType::I64, 3);
        crate::fbthrift::Serialize::write(&self.total_duration_in_us, p);
        p.write_field_end();
        if let ::std::option::Option::Some(some) = &self.other_stats {
            p.write_field_begin("other_stats", crate::fbthrift::TType::Map, 4);
...
impl<P> crate::fbthrift::Deserialize<P> for self::ProfilingStats
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("exec_duration_in_us", crate::fbthrift::TType::I64, 2),
            crate::fbthrift::Field::new("other_stats", crate::fbthrift::TType::Map, 4),
            crate::fbthrift::Field::new("rows", crate::fbthrift::TType::I64, 1),
            crate::fbthrift::Field::new("total_duration_in_us", crate::fbthrift::TType::I64, 3),
        ];
...
impl crate::fbthrift::GetTType for self::PlanNodeBranchInfo {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::PlanNodeBranchInfo
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("PlanNodeBranchInfo");
        p.write_field_begin("is_do_branch", crate::fbthrift::TType::Bool, 1);
        crate::fbthrift::Serialize::write(&self.is_do_branch, p);
        p.write_field_end();
        p.write_field_begin("condition_node_id", crate::fbthrift::TType::I64, 2);
        crate::fbthrift::Serialize::write(&self.condition_node_id, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::PlanNodeBranchInfo
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("condition_node_id", crate::fbthrift::TType::I64, 2),
            crate::fbthrift::Field::new("is_do_branch", crate::fbthrift::TType::Bool, 1),
        ];
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (crate::fbthrift::TType::Stop, _) => break,
                (crate::fbthrift::TType::Bool, 1) => {
                    field_is_do_branch =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::I64, 2) => {
                    field_condition_node_id =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (fty, _) => p.skip(fty)?,
            }
...
impl crate::fbthrift::GetTType for self::Pair {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::Pair
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
...
impl<P> crate::fbthrift::Deserialize<P> for self::Pair
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
...
impl crate::fbthrift::GetTType for self::PlanNodeDescription {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::PlanNodeDescription
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        p.write_field_end();
        p.write_field_begin("id", crate::fbthrift::TType::I64, 2);
        crate::fbthrift::Serialize::write(&self.id, p);
        p.write_field_end();
        p.write_field_begin("output_var", crate::fbthrift::TType::String, 3);
        crate::fbthrift::Serialize::write(&self.output_var, p);
        p.write_field_end();
        if let ::std::option::Option::Some(some) = &self.description {
            p.write_field_begin("description", crate::fbthrift::TType::List, 4);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.profiles {
            p.write_field_begin("profiles", crate::fbthrift::TType::List, 5);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.branch_info {
            p.write_field_begin("branch_info", crate::fbthrift::TType::Struct, 6);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.dependencies {
            p.write_field_begin("dependencies", crate::fbthrift::TType::List, 7);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        p.write_field_stop();
...
impl<P> crate::fbthrift::Deserialize<P> for self::PlanNodeDescription
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("branch_info", crate::fbthrift::TType::Struct, 6),
            crate::fbthrift::Field::new("dependencies", crate::fbthrift::TType::List, 7),
            crate::fbthrift::Field::new("description", crate::fbthrift::TType::List, 4),
            crate::fbthrift::Field::new("id", crate::fbthrift::TType::I64, 2),
            crate::fbthrift::Field::new("name", crate::fbthrift::TType::String, 1),
            crate::fbthrift::Field::new("output_var", crate::fbthrift::TType::String, 3),
            crate::fbthrift::Field::new("profiles", crate::fbthrift::TType::List, 5),
        ];
...
impl crate::fbthrift::GetTType for self::PlanDescription {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::PlanDescription
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("PlanDescription");
        p.write_field_begin("plan_node_descs", crate::fbthrift::TType::List, 1);
        crate::fbthrift::Serialize::write(&self.plan_node_descs, p);
        p.write_field_end();
        p.write_field_begin("node_index_map", crate::fbthrift::TType::Map, 2);
        crate::fbthrift::Serialize::write(&self.node_index_map, p);
        p.write_field_end();
        p.write_field_begin("format", crate::fbthrift::TType::String, 3);
        crate::fbthrift::Serialize::write(&self.format, p);
        p.write_field_end();
        p.write_field_begin("optimize_time_in_us", crate::fbthrift::TType::I32, 4);
        crate::fbthrift::Serialize::write(&self.optimize_time_in_us, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
...
impl<P> crate::fbthrift::Deserialize<P> for self::PlanDescription
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("format", crate::fbthrift::TType::String, 3),
            crate::fbthrift::Field::new("node_index_map", crate::fbthrift::TType::Map, 2),
            crate::fbthrift::Field::new("optimize_time_in_us", crate::fbthrift::TType::I32, 4),
            crate::fbthrift::Field::new("plan_node_descs", crate::fbthrift::TType::List, 1),
        ];
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                ...
                (crate::fbthrift::TType::List, 1) => {
                    field_plan_node_descs =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::Map, 2) => {
                    field_node_index_map =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::String, 3) => {
                    field_format =
...
impl crate::fbthrift::GetTType for self::ExecutionResponse {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::ExecutionResponse
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        p.write_struct_begin("ExecutionResponse");
        p.write_field_begin("error_code", crate::fbthrift::TType::I32, 1);
        crate::fbthrift::Serialize::write(&self.error_code, p);
        p.write_field_end();
        ...
        if let ::std::option::Option::Some(some) = &self.data {
            p.write_field_begin("data", crate::fbthrift::TType::Struct, 3);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.space_name {
            p.write_field_begin("space_name", crate::fbthrift::TType::String, 4);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.error_msg {
            p.write_field_begin("error_msg", crate::fbthrift::TType::String, 5);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.plan_desc {
            p.write_field_begin("plan_desc", crate::fbthrift::TType::Struct, 6);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.comment {
            p.write_field_begin("comment", crate::fbthrift::TType::String, 7);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        p.write_field_stop();
...
impl<P> crate::fbthrift::Deserialize<P> for self::ExecutionResponse
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("comment", crate::fbthrift::TType::String, 7),
            crate::fbthrift::Field::new("data", crate::fbthrift::TType::Struct, 3),
            crate::fbthrift::Field::new("error_code", crate::fbthrift::TType::I32, 1),
            crate::fbthrift::Field::new("error_msg", crate::fbthrift::TType::String, 5),
            crate::fbthrift::Field::new("latency_in_us", crate::fbthrift::TType::I64, 2),
            crate::fbthrift::Field::new("plan_desc", crate::fbthrift::TType::Struct, 6),
            crate::fbthrift::Field::new("space_name", crate::fbthrift::TType::String, 4),
        ];
...
impl crate::fbthrift::GetTType for self::AuthResponse {
    const TTYPE: crate::fbthrift::TType = crate::fbthrift::TType::Struct;
}

impl<P> crate::fbthrift::Serialize<P> for self::AuthResponse
where
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        p.write_field_end();
        if let ::std::option::Option::Some(some) = &self.error_msg {
            p.write_field_begin("error_msg", crate::fbthrift::TType::String, 2);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.session_id {
            p.write_field_begin("session_id", crate::fbthrift::TType::I64, 3);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.time_zone_offset_seconds {
            p.write_field_begin("time_zone_offset_seconds", crate::fbthrift::TType::I32, 4);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        if let ::std::option::Option::Some(some) = &self.time_zone_name {
            p.write_field_begin("time_zone_name", crate::fbthrift::TType::String, 5);
            crate::fbthrift::Serialize::write(some, p);
            p.write_field_end();
        }
        p.write_field_stop();
...
impl<P> crate::fbthrift::Deserialize<P> for self::AuthResponse
where
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[crate::fbthrift::Field] = &[
            crate::fbthrift::Field::new("error_code", crate::fbthrift::TType::I32, 1),
            crate::fbthrift::Field::new("error_msg", crate::fbthrift::TType::String, 2),
            crate::fbthrift::Field::new("session_id", crate::fbthrift::TType::I64, 3),
            crate::fbthrift::Field::new("time_zone_name", crate::fbthrift::TType::String, 5),
            crate::fbthrift::Field::new("time_zone_offset_seconds", crate::fbthrift::TType::I32, 4),
        ];
        let mut field_error_code = ::std::option::Option::None;
        let mut field_error_msg = ::std::option::Option::None;
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                ...
                (crate::fbthrift::TType::I32, 4) => {
                    field_time_zone_offset_seconds =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (crate::fbthrift::TType::String, 5) => {
                    field_time_zone_name =
                        ::std::option::Option::Some(crate::fbthrift::Deserialize::read(p)?)
                }
                (fty, _) => p.skip(fty)?,
            }
    ...
    P: crate::fbthrift::ProtocolWriter,
{
    fn write(&self, p: &mut P) {
        ...
        p.write_field_begin("version", crate::fbthrift::TType::String, 1);
    ...
    P: crate::fbthrift::ProtocolReader,
{
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        p.read_struct_end()?;
        ::std::result::Result::Ok(Self {
            version: field_version.unwrap_or_else(|| "3.0.0".as_bytes().into()),
            _dot_dot_Default_default: self::dot_dot::OtherFields(()),
        })
    }
}
